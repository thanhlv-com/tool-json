...
export function PatchWorkspace({
  ...
  return (
    <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 min-h-0">
      ...
      <section className="flex min-h-[220px] md:min-h-0 flex-col border-b border-[#D8DEE6] dark:border-[#262626]">
        <div className="flex items-center justify-between px-4 py-2 bg-[#FFFFFF] dark:bg-[#121214] text-[10px] font-mono text-[#6B7280] dark:text-[#606060] border-b border-[#D8DEE6] dark:border-[#262626]">
